...
Student Notes: basic structure imported from lecture notes
    ...
    resources
        templates
            ...
            front
                footer.php
                header.php
                top_nav.php - called from header.php
                slider.php - inserting DB call
            config.php - sets up environment and DB connection
            functions.php - has general functions, front end and back end sections. 
